...
<body>
    ...
    <br><br><br>
    <div class="container">
        <form style="width: 100%; margin-left: 10%; " method="POST" action="proceeds.php">
            <input name="title" type="text" id="title" class="form-control col-md-3" placeholder="Title" required="" autofocus="">
            <br>
            <div class="form-group shadow-textarea">
            <textarea class="form-control z-depth-5 col-md-9" input name="note"  id="exampleFormControlTextarea6" rows="30" placeholder="Type here..."></textarea>
            </div>
            <br><br>
